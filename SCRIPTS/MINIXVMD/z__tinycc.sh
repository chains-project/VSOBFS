#!bourne sh
# building Tiny C Compiler by TenDRA C/C++ compiler under Minix-vmd
#
# v.0.8 2023-03-03
# v.0.7 2023-03-02
# v.0.6 2023-03-01
...
# but it is not present in /opt/mnx2/include
# we add it for clarity here,
# in the same way as it will be actually needed at self-recompiles
cat >sys_mman.h <<'____'
#define PROT_READ      1
#define PROT_WRITE     2
#define PROT_EXEC      4
...
#define TCC_VERSION "git-${tver}-1_minixvmd"
#define GCC_MAJOR 0
#define GCC_MINOR 0
...
cat > /opt/mnx2/include/stdint.h <<'____'
/*
...
_frexp:
        ...
        ret
.fef8:
// there is apparently room for improvement, on fp hardware,
