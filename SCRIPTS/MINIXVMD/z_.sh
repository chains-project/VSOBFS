...
#
# this script is to be sourced at the beginning of every ?_?*.sh script as
#  . "$A"/SCRIPTS/XXXX/z_.sh
# where XXXX is the operating system tag like MINIXVMD
...
# this is not be used on platforms with short
# file name components, unless the file name is known
# to be shorter than the limitation,
# otherwise this removes the file itself:
ffix(){ fix "$@"; rm "$fixfile"_ "$fixfile".; }
